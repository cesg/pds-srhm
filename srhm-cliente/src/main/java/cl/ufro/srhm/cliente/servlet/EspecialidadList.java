...
import cl.ufro.srhm.soap.EspecialidadSOAPProxy;
...
public class EspecialidadList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		EspecialidadSOAPProxy especialidadSOAP = new EspecialidadSOAPProxy();
		response.setCharacterEncoding("utf-8");
		String especialidades = especialidadSOAP.obtenerEspecialidades();
