...
public class SRHMERPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "SRHMER";
	...
	private SRHMERPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Persona.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Medico.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Especialidad.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Paciente.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Director.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.HoraMedica.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Box.class);
		configuration.addAnnotatedClass(cl.ufro.srhm.orm.Reserva.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new SRHMERPersistentManager();
		}
