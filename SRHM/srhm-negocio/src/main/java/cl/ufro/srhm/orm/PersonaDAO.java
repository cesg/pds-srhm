...
public class PersonaDAO {
	private static final org.slf4j.Logger _logger = org.slf4j.LoggerFactory.getLogger(PersonaDAO.class);
	public static Persona loadPersonaByORMID(int id) throws PersistentException {
		try {
			...
			_logger.error("loadPersonaByORMID(int id)", e);
	...
	public static Persona getPersonaByORMID(int id) throws PersistentException {
		try {
			...
			_logger.error("getPersonaByORMID(int id)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona loadPersonaByORMID(int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			...
			_logger.error("loadPersonaByORMID(int id, org.hibernate.LockMode lockMode)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona getPersonaByORMID(int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			...
			_logger.error("getPersonaByORMID(int id, org.hibernate.LockMode lockMode)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona loadPersonaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Persona) session.load(cl.ufro.srhm.orm.Persona.class, new Integer(id));
		}
		catch (Exception e) {
			_logger.error("loadPersonaByORMID(PersistentSession session, int id)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona getPersonaByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Persona) session.get(cl.ufro.srhm.orm.Persona.class, new Integer(id));
		}
		catch (Exception e) {
			_logger.error("getPersonaByORMID(PersistentSession session, int id)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona loadPersonaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Persona) session.load(cl.ufro.srhm.orm.Persona.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			_logger.error("loadPersonaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona getPersonaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Persona) session.get(cl.ufro.srhm.orm.Persona.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			_logger.error("getPersonaByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static List queryPersona(String condition, String orderBy) throws PersistentException {
		try {
			...
			_logger.error("queryPersona(String condition, String orderBy)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona[] listPersonaByQuery(String condition, String orderBy) throws PersistentException {
		try {
			...
			_logger.error("listPersonaByQuery(String condition, String orderBy)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static List queryPersona(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From cl.ufro.srhm.orm.Persona as Persona");
		if (condition != null)
		...
		try {
			...
			_logger.error("listPersonaByQuery(PersistentSession session, String condition, String orderBy)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona loadPersonaByQuery(String condition, String orderBy) throws PersistentException {
		try {
			...
			_logger.error("loadPersonaByQuery(String condition, String orderBy)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static java.util.Iterator iteratePersonaByQuery(String condition, String orderBy) throws PersistentException {
		try {
			...
			_logger.error("iteratePersonaByQuery(String condition, String orderBy)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static java.util.Iterator iteratePersonaByQuery(PersistentSession session, String condition, String orderBy) throws PersistentException {
		...
		try {
			...
			_logger.error("iteratePersonaByQuery(PersistentSession session, String condition, String orderBy)", e);
			throw new PersistentException(e);
		}
	}
	...
	public static Persona createPersona() {
		return new cl.ufro.srhm.orm.Persona();
	}
	
	public static boolean save(cl.ufro.srhm.orm.Persona persona) throws PersistentException {
		try {
			cl.ufro.srhm.orm.SRHMERPersistentManager.instance().saveObject(persona);
			return true;
		}
		catch (Exception e) {
			_logger.error("save(cl.ufro.srhm.orm.Persona persona)", e);
			throw new PersistentException(e);
		}
	}
	
	public static boolean delete(cl.ufro.srhm.orm.Persona persona) throws PersistentException {
		try {
			cl.ufro.srhm.orm.SRHMERPersistentManager.instance().deleteObject(persona);
			return true;
		}
		catch (Exception e) {
			_logger.error("delete(cl.ufro.srhm.orm.Persona persona)", e);
			throw new PersistentException(e);
		}
	}
	
	public static boolean deleteAndDissociate(cl.ufro.srhm.orm.Persona persona)throws PersistentException {
		try {
			if(persona.getMedico() != null) {
				persona.getMedico().setUsuario(null);
			}
			
			if(persona.getPaciente() != null) {
				persona.getPaciente().setUsuario(null);
			}
			
			if(persona.getDirector() != null) {
				persona.getDirector().setUsuario(null);
			}
			
			cl.ufro.srhm.orm.Reserva[] lReservas = persona.reserva.toArray();
	...
	public static boolean deleteAndDissociate(cl.ufro.srhm.orm.Persona persona, org.orm.PersistentSession session)throws PersistentException {
		try {
			if(persona.getMedico() != null) {
				persona.getMedico().setUsuario(null);
			}
	...
	public static boolean refresh(cl.ufro.srhm.orm.Persona persona) throws PersistentException {
		try {
			cl.ufro.srhm.orm.SRHMERPersistentManager.instance().getSession().refresh(persona);
			return true;
		}
		catch (Exception e) {
			_logger.error("refresh(cl.ufro.srhm.orm.Persona persona)", e);
			throw new PersistentException(e);
		}
	}
	
	public static boolean evict(cl.ufro.srhm.orm.Persona persona) throws PersistentException {
		try {
			cl.ufro.srhm.orm.SRHMERPersistentManager.instance().getSession().evict(persona);
			return true;
		}
		catch (Exception e) {
			_logger.error("evict(cl.ufro.srhm.orm.Persona persona)", e);
			throw new PersistentException(e);
		}
	}
